...
//        BluetoothAdapter bluetoothAdapter = (BluetoothManager) getSystemService(Context.BLUETOOTH_SERVICE).getDefaultAdapter();
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_list_recyclerviewitem, parent, false);
        return new VH(view);
    }
    ...
    class VH extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        VH(final View itemView) {
            ...
            address = itemView.findViewById(R.id.item_device_address);
        }
